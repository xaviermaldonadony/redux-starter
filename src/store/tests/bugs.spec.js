...
import { loadBugs, addBug, resolveBug, getUnresolvedBugs } from '../bugs-tk.js';
...
describe('bugsSlice', () => {
	...
	describe('loading bugs', () => {
		describe('if the bugs exist in the cache', () => {
			it('they should not be feteched from the server again.', async () => {
		...
		describe("if the bugs don't exist in the cache", () => {
			...
			it('should be true while fetching the bugs', () => {
				// fakeAxios.onGet("/bugs").reply(200, [{id: 1}])
				// passing a function we can execute code before the server responds
